...
const Button = (props: ButtonProps) => {
  ...
  const defaultStyles =
    "rounded-[18px] flex capitalize items-center justify-center gap-[9px] hover:scale-105 transition-all duration-300 w-fit text-white text-base lg:text-lg font-semibold font-['Jost'] leading-snug tracking-tight px-10 py-5 md:px-[54px] md:py-[26px]";
